public class InventoryManagment {
    ...
    public static void main(String[] args) {
        ...
        // Produce
        Product plum = new Product(1, "Pack of Plums", produce.getCategoryName(), 8.50, 10);
        Product carrot = new Product(2, "Pack of Carrots", produce.getCategoryName(), 3.99, 30);
        // Dairy
        Product milk = new Product(3, "Gallon of Milk", dairy.getCategoryName(), 2.99, 20);
        ...
        Product groundBeef = new Product(6, "Ground Beef (1 lb)", meats.getCategoryName(), 6.49, 40);
        // Grains
        Product rice = new Product(7, "Bag of Rice (5 lbs)", grains.getCategoryName(), 4.99, 50);
        Product oats = new Product(8, "Container of Oats (2 lbs)", grains.getCategoryName(), 3.79, 30);
        // Drinks 
        Product orangeJuice = new Product(9, "Gallon of Orange Juice", drinks.getCategoryName(), 3.29, 18);
        Product soda = new Product(10, "Can of Soda", drinks.getCategoryName(), 0.99, 60);
        // Snacks category
        Product chips = new Product(11, "Bag of Potato Chips", snacks.getCategoryName(), 2.49, 25);
        Product chocolateBar = new Product(12, "Chocolate Bar", snacks.getCategoryName(), 1.29, 40);
